    ...
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        ...
        <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
            ...
            <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                ...
                <li class="breadcrumb-item text-dark">Clientes</li>
                <!--Item-->
            </ul>
            <!--Breadcrumb-->
        </div>
                ...
                <table id="kt_datatable_example_5" class="table table-striped table-row-bordered gy-2 gs-7 rounded">
                    <thead>
                        <tr class="fw-bolder fs-6 text-gray-800 px-7">
                            ...
                            <th class="min-w-120px">Cedula</th>
                            <th class="min-w-120px">Pasaporte</th>
                            <th class="min-w-120px">Celular</th>
                    ...
                    <tbody>
                        <tr>
                            <td>1</td>
                            <td>Miguelina Castro</td>
                            <td>222-3334444-1</td>
                            <td></td>
                            <td>809-220-1111</td>
                            <td>809-555-5555</td>
                            <td class="text-end">
                                <a href="#" class="btn btn-sm btn-light btn-active-primary" data-kt-menu-trigger="click"
                                    data-kt-menu-placement="bottom-end"><i class="fas fa-ellipsis-v"></i>
